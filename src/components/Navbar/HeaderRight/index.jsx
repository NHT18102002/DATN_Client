...
const HeaderRight = () => {
  ...
  const { avatar, username, productCart, vendor } = useSelector(
  ...
  const menu = [
    {
      key: "1",
      label: (
        <div className="menuUserItem" onClick={() => navigate("/my-account")}>
    ...
    },
    {
      key: "2",
      label: (
        <div className="menuUserItem" onClick={() => navigate("/orders")}>
...

    {
      ...
      label:
        vendor == "1" ? (
          <div className="menuUserItem" onClick={() => navigate("/manage-shop/products")}>
            <ShopOutlined className="menuUserItem__icon" />
            <span>Cửa hàng</span>
          </div>
        ) : vendor == "0" ? (
          <div className="menuUserItem" onClick={() => navigate("/apply-shop")}>
            <ShopOutlined className="menuUserItem__icon" />
            <span>Ứng tuyển</span>
          </div>
        ) : null,
